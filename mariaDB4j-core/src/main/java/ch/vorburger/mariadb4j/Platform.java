 ...
 * OS Detector.
 *
 * <p>Includes a method for cross-platform tests to temporarily override OS to simulate running on
 * another one.
 *
...
final class Platform implements AutoCloseable {
    ...
    private static final OS real =
            SystemUtils.IS_OS_WINDOWS ? OS.WINDOWS : SystemUtils.IS_OS_MAC ? OS.MAC : OsUtils.isAlpine() ? OS.ALPINE : OS.LINUX;
